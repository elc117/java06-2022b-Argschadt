...
class GroupAssignment extends Assignment {
  ...
  public String message() {
    if(status() == "done"){
      return "Group Assignment " + getDescription() + " is " + status();
    }
    else if(status() == "late"){
      return "Group Assignment " + getDescription() + " is " + status() + " - call " + this.teamMates;
    }
    else{
      return "Group Assignment " + getDescription() + " is " + status() + " - call " + this.teamMates;
    }
...
public class TrackAssignments {
  public static void main(String[] args) {
    ...
    if(i==0){
      System.out.println("There is no assignments done!");
    }
    else if(i==1){
      System.out.println("There is " + i + " assignment done!");
    }
    else{
      System.out.println("There are " + i + " assignments done!");
    }
  }
